...
extern void     skipRecData();					/* 10a3 33 ok++	*/
...
extern void     symRecPass2();					/* 1e32 50 ok++	*/
extern void     symRecPass1();					/* 203a 51 ok++	*/
extern void     defineSym(char *, sym_t *, uint32_t, int);	/* 2197 52 ok++ */
extern void     defineIfNeeded(char *, sym_t *, uint32_t, int); /* 22c3 53 ok++ */
extern void     psectRecPass1();				/* 233a 54 ok++	*/
extern void     xpsectRecPass1();				/* 2382 55 ok++	*/
extern void     endRecPass1();					/* 2514 56 ok++	*/
extern void     endRecPass2();					/* 259e 57 ok++	*/
